...
const features = [
  {
    ...
    description: 'Whether it\'s a receipt, invoice, or bank statement, we\'ll take care of it.',
    icon: CloudArrowUpIcon,
  },
  {
    name: 'Data Privacy.',
    description: 'We understand the importance of data privacy. Your data is encrypted and stored securely via trusted industry providers.',
    icon: LockClosedIcon,
  },
  {
